...
<head>
	<title>Admin | Especializaciones</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Admin | Añadir especialización de médico</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Admin</span>
								...
								<li class="active">
									<span>Añadir especialización de médico</span>
								</li>
							</ol>
						</div>
					</section>
					...
					<div class="container-fluid container-fullw bg-white">
									...
									<div class="col-lg-6 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">Especializaciones</h5>
											</div>
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Gestionar<span class="text-bold"> Especialización del doctor</span></h5>

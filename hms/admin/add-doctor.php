											...
											<div class="panel-body">
												...
												<form role="form" name="adddoc" method="post" onSubmit="return valid();">
													...
													<div class="form-group">
														...
														<textarea name="clinicaddress" class="form-control" placeholder="Ingrese Dirección" required="true"></textarea>
													</div>
													<div class="form-group">
														<label for="fess">
															Honorarios de consultoría médico
														</label>
														<input type="text" name="docfees" class="form-control" placeholder="Ingrese los honorarios de consultoría médico" required="true">
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="doccontact" class="form-control" placeholder="Ingrese el contacto del Doctor" required="true">
													</div>
													...
													<div class="form-group">
														...
														<input type="email" id="docemail" name="docemail" class="form-control" placeholder="Ingrese el email del Doctor" required="true" onBlur="checkemailAvailability()">

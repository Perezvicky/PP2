...
//updating Comentario del administrador
if (isset($_POST['update'])) {
	...
	if ($query) {
		echo "<script>alert('Comentario del administrador updated successfully.');</script>";
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Admin | Detalles de consulta</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Admin</span>
					...
					<div class="container-fluid container-fullw bg-white">
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Gestionar<span class="text-bold">Detalles de consulta</span></h5>

...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_query($con, "Actualizar doctors set specilization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno',docEmail='$docemail' where id='$did'");
	if ($sql) {
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Admin | Editar detalles del doctor</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Admin</span>
